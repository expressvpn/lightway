      ...
      perSystem =
        ...
        }:
        {
          ...
          packages = {
            ...
            lightway-client-boringssl-beta = config.packages."lightway-${nativeSuffix}-boringssl-beta";
            lightway-server-boringssl-beta = config.packages."lightway-${nativeSuffix}-boringssl-beta";
          };
