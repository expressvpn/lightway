      ...
      perSystem =
        ...
        }:
        {
          ...
          packages = {
            ...
            lightway-client-boringssl-beta = config.packages."lightway-client-${nativeSuffix}-boringssl-beta";
            lightway-server-boringssl-beta = config.packages."lightway-server-${nativeSuffix}-boringssl-beta";
          };
