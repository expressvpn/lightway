...
pub struct Connection<AppState: Send = ()> {
    ...
    // Track if expresslane is degraded and should not be used
    expresslane_degraded: bool,
...
impl<AppState: Send> Connection<AppState> {
    ...
    fn disable_expresslane(&mut self) {
        self.expresslane.enabled = false;
        self.expresslane_degraded = true;
