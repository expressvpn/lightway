...
impl DnsManager {
    ...
    /// Generates resolv.conf content with public DNS servers routed via VPN tunnel
    fn generate_resolv_conf_content(_dns_server: IpAddr) -> String {
        let nameservers: String = PUBLIC_DNS
            .iter()
...
mod tests {
    ...
    fn test_content_format() {
        ...
        assert_eq!(lines[3], "nameserver 1.1.1.1");
    }
