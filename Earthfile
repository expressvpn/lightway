...
source:
    ...
    COPY --keep-ts --dir lightway-core lightway-expresslane lightway-app-utils lightway-bpf-steering lightway-offload-engine lightway-client uniffi-bindgen lightway-server tests ./
